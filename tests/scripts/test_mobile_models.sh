...
CUDA_VISIBLE_DEVICES=7 uv run python -m tests.test_mobile_models --model "gemini-3-pro-preview"
CUDA_VISIBLE_DEVICES=7 uv run python -m tests.test_mobile_models --model "gpt-5.2-2025-12-11"
CUDA_VISIBLE_DEVICES=7 uv run python -m tests.test_mobile_models --model "claude-sonnet-4-5-20250929"
CUDA_VISIBLE_DEVICES=7 uv run python -m tests.test_mobile_models --model "gpt-4o-mini"