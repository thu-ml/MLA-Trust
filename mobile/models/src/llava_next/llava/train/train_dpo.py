...
from models.src.llava_next.llava.constants import IGNORE_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, IMAGE_TOKEN_INDEX
from torch.utils.data import Dataset
from models.src.llava_next.llava.train.llava_trainer import LLaVADPOTrainer
from data_processing.utils import load_jsonl, load_json
from models.src.llava_next.llava import conversation as conversation_lib
from models.src.llava_next.llava.model import *
from models.src.llava_next.llava.model.language_model.llava_qwen import LlavaQwenConfig
from models.src.llava_next.llava.model.language_model.llava_llama import LlavaConfig
from models.src.llava_next.llava.model.language_model.llava_mistral import LlavaMistralConfig
from models.src.llava_next.llava.mm_utils import process_highres_image, process_anyres_image, process_highres_image_crop_split, tokenizer_image_token
from models.src.llava_next.llava.utils import rank0_print
...
class ModelArguments:
    ...
    model_class_name: Optional[str] = field(default=None, metadata={"help": "Used to init model class, format is XXXXForCausalLM. e.g. currently XXXX is chosen from models.src.llava_next.llavaLlama, LlavaMixtral, LlavaMistral, Llama"})
