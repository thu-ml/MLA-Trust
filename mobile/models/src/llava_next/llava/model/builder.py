...
from models.src.llava_next.llava.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
    ...
    if "llava" in model_name.lower() or is_multimodal:
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            if "mixtral" in model_name.lower():
                from models.src.llava_next.llava.model.language_model.llava_mixtral import LlavaMixtralConfig
                ...
                from models.src.llava_next.llava.model.language_model.llava_gemma import LlavaGemmaConfig
            ...
            if "mixtral" in model_name.lower():
                ...
                if "moe" in model_name.lower() or "A14B" in model_name.lower():
                    from models.src.llava_next.llava.model.language_model.llava_qwen_moe import LlavaQwenMoeConfig
