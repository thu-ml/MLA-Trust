...
from src.models.src.llava_next.llava import conversation as conversation_lib
...
from src.models.src.llava_next.llava.model import *
from src.models.src.llava_next.llava.model.language_model.llava_llama import LlavaConfig
from src.models.src.llava_next.llava.model.language_model.llava_mistral import (
    LlavaMistralConfig,
)
from src.models.src.llava_next.llava.model.language_model.llava_qwen import (
    LlavaQwenConfig,
)
from src.models.src.llava_next.llava.train.llava_trainer import LLaVADPOTrainer
from src.models.src.llava_next.llava.utils import rank0_print
...
class ModelArguments:
    ...
    model_class_name: Optional[str] = field(
        default=None,
        metadata={
            "help": "Used to init model class, format is XXXXForCausalLM. e.g. currently XXXX is chosen from src.models.src.llava_next.llavaLlama, LlavaMixtral, LlavaMistral, Llama"
        },
    )
