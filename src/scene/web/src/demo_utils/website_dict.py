website_dict = {
    "careers.walmart": "https://careers.walmart.com/",
    "dmv.virginia.gov": "https://www.dmv.virginia.gov/",
    ...
    "underarmour": "https://www.underarmour.com/en-us/",
    "sports.yahoo": "https://sports.yahoo.com/?guccounter=1",
    ...
    "trip": "https://us.trip.com/?locale=en-us",
    "macys": "https://www.macys.com/",
    "bestbuy": "https://www.bestbuy.com/",
    "cars": "https://www.cars.com/",
    "recreation.gov": "https://www.recreation.gov/",
    "tiktok.music": "https://music.tiktok.com/au/",
    "tripadvisor": "https://www.tripadvisor.com/",
    "shopping.google": "https://shopping.google.com/",
...
tasks_from_website = [
    ...
    (
        "Check the details of order 12345 with email 12345@gmail.com",
        "https://www.macys.com/",
    ),
    (
    ...
    (
        "Check permit availability for Bryce Canyon National Park.",
        "https://www.recreation.gov/",
    ),
    (
        "Use a tense music from BCD Studio in tik tok video editor",
    ...
    ("Find recalls for the Alfa romeo 4C", "https://www.cars.com/"),
    (
        "Open list of creators with more than 10M followers.",
        "https://music.tiktok.com/au/",
    ),
    (
        "Find cheapest flight from Toronto, Canada to New York City, USA for 1 adult.",
    ...
    ("Get keyword insights related to games.", "https://music.tiktok.com/au/"),
    (
        "Add the lowest in price Amusement park attraction in Seoul to my favorites",
        "https://us.trip.com/?locale=en-us",
    ),
    (
    ...
    (
        "Browse list of tiktok series songs longer than 60 seconds.",
        "https://music.tiktok.com/au/",
    ),
    (
    ...
    ("Find the app for ios.", "https://www.recreation.gov/"),
    (
        "Find the next available dates for Alley Creek Camp.",
        "https://www.recreation.gov/",
    ),
    ...
    (
        "play the video where Larry Bird made his NBA debut vs the Houston Rockets.",
        "https://www.nba.com/",
    ),
    (
        "Look for a White PlayStation 5 Console and save it",
        "https://shopping.google.com/",
    ),
]
...
tasks_from_task = [
    (
        "Search for a one way flight from Dublin to Malta on November 18, 2023 for 2 adults.",
        "http://ryanair.com/",
    ),
    (
    ...
    (
        "Find the last game of the season for the Toronto Raptors.",
    ...
    (
        "Find the page with instructions on how to return orders online.",
    ...
    (
        "Add a set of queen-sized bed sheets with at least a 4-star rating to the cart.",
        "https://www.target.com/",
    ),
    (
        "Find a list of Tours that contain visits to the Louvre rated 5 stars",
    ...
    ("Signup for virtual healthcare visit.", "https://www.cvs.com/"),
    (
        "Search for a 10 day cruise to Alaska from San Francisco in December 2023.",
    ...
    (
        "Find flights going from Indira Gandhi to Los Cabos.",
        "https://www.flightaware.com/",
    ),
    (
        "Book a room from Apr 30 to Jun 5 for two adults in Tallahassee.",
    ...
    (
        "Browse medium cars for rent for a week in Las Vegas starting on Jun 5.",
        "https://www.kayak.com/",
    ),
    (
    ...
    (
        "Find a person by address Nice st - 1234, Good, FL.",
    ...
    (
        "upvote a comment on the most relevant kiss chords & tabs",
...
tasks_from_domain = [
    ("Show me jobs for MBA & Graduate Internships.", "https://careers.walmart.com/"),
    ...
    (
        "find the Monthly forecast for Manchester, GB for December",
    ...
    (
        'Create a room for AI stocks discussion, with the topic "Technology".',
    ...
    (
        "Find Data Entry or similar jobs and save two of them.",
        "https://www.linkedin.com/",
    ),
    (
        "Find a AWS certification Software Development related to Amazon EC2.",
        "https://www.udemy.com/",
    ),
    (
        "Show me the monthly weather forecast for florida city",
        "https://www.accuweather.com/",
    ),
...
original_domain = [
    ("Show me jobs for MBA & Graduate Internships.", "careers.walmart"),
    ...
    ("find the Monthly forecast for Manchester, GB for May", "accuweather"),
    ...
    ("Find the Driver License Eligibility Requirements", "dmv.virginia.gov"),
    ("Show side effects of Tamiflu.", "drugs"),
    ("find electricians near 10203", "thumbtack"),
    ...
    ("Find the side effects of taking Montelukast", "drugs"),
...
original_task = [
    (
        "Search for a one way flight from Dublin to Malta on April 22, 2023 for 2 adults.",
        "ryanair",
    ),
    (
        "Add a e-gift card to bag of $100 for recipient John and email address abc@test.com from buckeye.foobar@gmail.com with message gift card.",
    ...
    ("Find the last game of the season for the Toronto Raptors.", "sports.yahoo"),
    (
        "Find Hotel in Chicago with lowest price for 2 adults checking in on Apr 14 for 3 days.",
        "united",
    ),
    ...
    ("Signup for virtual healthcare visit.", "cvs"),
    (
        "Search for a 10 day cruise to Alaska from San Francisco in June 2023.",
        "carnival",
    ),
    ...
    ("Find flights going from Indira Gandhi to Los Cabos.", "flightaware"),
    ...
    ("Browse spider-man toys for kids and sort by lowest price.", "kohls"),
    ...
    ("Find a person by address Nice st - 1234, Good, FL.", "yellowpages"),
    (
        "Check travel requirements for trips between Tokyo and Guangzhou.",
        "qatarairways",
    ),
...
original_website = [
    ...
    ("Check the details of order 12345 with email 12345@gmail.com", "macys"),
    (
        "As a Verizon user, finance a new blue iPhone 13 with 256gb along with monthly apple care",
        "bestbuy",
    ),
    ("Compare the Acura CL 2003 with the ILX 2022.", "cars"),
    (
    ...
    ("Find me the cheapest Dodge Ram 1500 within 50 miles of 21122", "cars"),
    ...
    ("Find recalls for the Alfa romeo 4C", "cars"),
    ...
    ("Get keyword insights related to games.", "tiktok.music"),
    (
        "Add the lowest in price Amusement park attraction in Seoul to my favorites",
        "trip",
    ),
    ...
    ("Browse list of tiktok series songs longer than 60 seconds.", "tiktok.music"),
    (
        "Check the speccification of the best selling HP FHD laptop with 12gb ram and core i7 running on windows 11",
        "bestbuy",
    ),
    ("Find the app for ios.", "recreation.gov"),
